...
import { ProcessedData, KnowledgeItem } from '../types.js';
...
export class KnowledgeProcessor {
     ...
     */
    async generateSparseVector(text: string) {
     ...
     */
    async processKnowledgeItem(item: KnowledgeItem): Promise<ProcessedData> {
