...
import { CallToolRequestSchema, ListToolsRequestSchema, ListResourcesRequestSchema, ReadResourceRequestSchema, CreateMessageRequestSchema, CreateMessageResultSchema } from "@modelcontextprotocol/sdk/types.js";
...
async function createSamplingMessage(messages, systemPrompt) {
    const request = {
    ...
    const result = await server.request(CreateMessageRequestSchema, request, CreateMessageResultSchema);
