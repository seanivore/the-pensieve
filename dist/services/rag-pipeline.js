...
export class RAGPipeline {
    ...
    async processAndStoreKnowledge(knowledgeItems) {
        ...
        for (const item of knowledgeItems) {
            try {
                ...
                // Store in Qdrant
                await this.qdrantService.storeMemory(processedData.vector, processedData.sparseVector, processedData.payload);
                successCount++;
    ...
    async semanticSearch(query, filters = {}, limit = 5) {
        ...
        const seen = new Map(); // Use Map to track both content and scores
